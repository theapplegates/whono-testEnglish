...
vite: {
      plugins: [],
      ssr: {
        // Allow Vite to handle Svelte components during SSR/Build
        noExternal: ['astro-cloudinary', '@radix-ui/*', '@lucide/svelte']
      },
      define: {
      ...
      optimizeDeps: {
        ...
        // Exclude Svelte package from esbuild pre-bundling
        exclude: ['astro-cloudinary', '@lucide/svelte']
      },
      build: {
        cssMinify: true,
        minify: 'esbuild'
